...
import ru.mail.park.docker.services.ContainersFragmentsDataProvider;
...
public class DataProvidersModule {
    ...
    @ProfileScope
    @Provides
    public ContainersFragmentsDataProvider provideContainersDataProvider(
            ContainerApi api,
    ...
    @ProfileScope
    @Provides
    public ImagesFragmentsDataProvider provideImagesDataProvider(
            ImageApi api,
            IAsyncTaskHandler requestHandler,
