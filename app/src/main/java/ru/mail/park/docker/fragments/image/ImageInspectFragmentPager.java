...
public class ImageInspectFragmentPager extends Fragment {
    ...
    class ImageInspectPageAdapter extends FragmentStatePagerAdapter {

        ImageInspectPageAdapter(FragmentManager fm) {
            super(fm);
        }
        ...
        public Fragment getItem(int position) {
            ...
            return ImagesInspectFragment.newInstance(mImageName, tab);
        }
